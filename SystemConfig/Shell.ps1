...
InitWin-DefineEntry -Id System.Shell.Multitasking -Name '多任务 / Alt+Tab / Aero Shake' -Profiles @() -Validate {
...
InitWin-DefineEntry -Id System.Shell.Explorer -Name '高级 / 任务栏 / 文件管理器' -Profiles @() -Validate {
