$defineMicrosoftStorePackage = {
    ...
    InitWin-DefineEntry -Id "Packages.MicrosoftStore.$EntryName" -Name "Microsoft Store: $Name" -Profiles $Profiles -Validate $validate -Apply $apply
}
...
& $defineMicrosoftStorePackage -EntryName TelegramDesktop -Name 'Telegram Desktop' -Id '9NZTWSQNTD0S' `
    ...
    -Profiles @('!Basic')
& $defineMicrosoftStorePackage -EntryName Basic.NanaZip -Name 'NanaZip' -Id '9N8G7TSCL18R' `
...
& $defineMicrosoftStorePackage -EntryName Mitmproxy -Name 'mitmproxy' -Id '9NWNDLQMNZD7' `
    ...
    -Profiles @('!Basic')
& $defineMicrosoftStorePackage -EntryName Basic.Snipaste -Name 'Snipaste' -Id '9P1WXPKB68KX' `
